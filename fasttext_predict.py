...
model=FastText(cfg)
model.load_state_dict(torch.load('checkpoints/FastText.pth', map_location='cpu'))
model.to(cfg.device)
model.eval()
train_file='fasttext_features_seq1000/train_feature.txt'
test_file='fasttext_features_seq1000/test_feature.txt'
with torch.no_grad():
    train_data=[]
