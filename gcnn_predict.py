...
model=GCNN(cfg)
model.load_state_dict(torch.load('checkpoints/GCNN.pth'))
model.to(cfg.device)
model.eval()
train_file='gcnn_features_seq1000/train_feature.txt'
test_file='gcnn_features_seq1000/test_feature.txt'
with torch.no_grad():
    train_data=[]
